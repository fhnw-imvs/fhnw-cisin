...
func (x *Connection) GetQuery() string {
	if x != nil {
		return x.Query
	}
	return ""
...
func (x *Connection) GetPageNumber() int32 {
	if x != nil {
		return x.PageNumber
	}
	return 0
...
func (x *Connection) GetResultsPerPage() int32 {
	if x != nil {
...
var file_proto_message_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6d, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	...
	0x50, 0x61, 0x67, 0x65, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e, 0x66,
